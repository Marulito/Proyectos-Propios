...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-09-2018 a las 04:51:44
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_RegistrarModificarContenidoVista` (IN `idProce` INT, IN `doc` VARCHAR(13), IN `nombre` VARCHAR(45), IN `idTipoP` INT, IN `idSubProce` INT, IN `op` INT)  NO SQL
BEGIN
